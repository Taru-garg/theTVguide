...
def write_file(filename, text,movie):
    ...
    try:
        ...
        #for movies that don't belong to a collection, assign null
        release = None       
    result = [movie,dataset['original_title'],overview,genre,release,collection_name,backdrop_path,poster_path]
    # write data
...
csvwriter = csv.writer(csvFile)
csvwriter.writerow(['ID','Movie_name','Overview','Genres','Release Date','Collection_name','backdrop_path','poster_path'])
csvFile.close()
